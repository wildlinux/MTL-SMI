...
import pickle
import pandas as pd
from model.MTL_pheme_single import MTL
from sklearn.metrics import classification_report, accuracy_score

from dataset import MTLDataset_pheme_single
...
parser.add_argument("-t", "--task", help="任务名称/数据集名称", type=str, default="pheme_single")
...
if __name__ == "__main__":
    ...
    word_embeddings = np.load('dataset/word_embeddings_pheme_single.npy')
