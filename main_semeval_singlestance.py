...
from model.MTL_semeval_singlestance import MTL
from dataset import MTLDataset_semeval_singlestance

import argparse

parser = argparse.ArgumentParser()
parser.description = "实验参数配置"
parser.add_argument("-t", "--task", help="任务名称/数据集名称", type=str, default="semeval_singlestance")
...
if __name__ == "__main__":
    ...
    word_embeddings = np.load('dataset/word_embeddings_semeval_singlestance.npy')
