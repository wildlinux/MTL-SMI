...
class MTL(torch.nn.Module):
    ...
    def forward(self, batch):
        ...
        # (n,2dim)
        stance_feature_posttext = stance_feature_posttext.transpose(0, 1).contiguous().view(stance_feature_posttext.shape[1], -1)
        ...
        # (n,2dim)
        stance_feature_commenttext = stance_feature_commenttext.transpose(0, 1).contiguous().view(stance_feature_commenttext.shape[1], -1)
