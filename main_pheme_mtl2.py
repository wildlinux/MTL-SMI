...
import pickle
import pandas as pd
from model.MTL_pheme_mtl2 import MTL
from AutomaticWeightedLoss import AutomaticWeightedLoss
from dataset2 import MTLDataset_pheme_mtl
...
def save_exp_res(res: dict):
    ...
    columns.append('0_whole_f1')
    columns.append('1_whole_f1')
    columns.append('2_whole_f1')
...
if __name__ == "__main__":
    ...
    # word_embeddings = np.load('dataset/word_embeddings_pheme_mtl2.npy')
    ...
    res_tmp = classification_report(list_label, list_pred, digits=5, output_dict=True)
    res1['0_whole_f1'] = res_tmp['0']['f1-score']
    res1['1_whole_f1'] = res_tmp['1']['f1-score']
    res1['2_whole_f1'] = res_tmp['2']['f1-score']
