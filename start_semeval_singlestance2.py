...
parser.add_argument("-g", "--gpu_avail", help="可用的gpu编号,逗号隔开, 如-g 0,1,2,3,4", type=str, default="0")
parser.add_argument("-d", "--description", help="实验描述, 英文描述, 不带空格", type=str, default="0116")
parser.add_argument("-p", "--per", help="每块显卡上跑几个程序", type=int, default="2")
args = parser.parse_args()

script_name = 'main_semeval_singlestance2.py'
