...
import pickle
import pandas as pd
from model.MTL_semeval_single import MTL
from sklearn.metrics import classification_report, accuracy_score

from dataset import MTLDataset_semeval_single
...
parser.add_argument("-t", "--task", help="任务名称/数据集名称", type=str, default="semeval_single")
...
if __name__ == "__main__":
    ...
    word_embeddings = np.load('dataset/word_embeddings_semeval_single.npy')
